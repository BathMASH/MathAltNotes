...
if [ $level != "1" ]; then 
echo "-----------------------------------------------------------------"
echo "Making accessible web format (single page)"
echo "=========================================="
make websingle name=$name > .quickMake-websingle.out
echo "-----------------------------------------------------------------"
echo "Delivery of packaged multiple formats"
echo "====================================="
make deliver name=$name > .quickMake-deliver.out
fi
if [ $level == "1" ]; then
echo "-----------------------------------------------------------------"
echo "Delivery of packaged multiple formats"
echo "====================================="
make deliverhandout name=$name > .quickMake-deliverhandout.out
fi
make clean
make cleaner
echo "-----------------------------------------------------------------"
...
echo "You should find standard, clear, large, web and word formats as"
echo "well as packaged formats for ease of upload to Moodle (.zip)"
echo "-----------------------------------------------------------------"
...
echo "an infinite loop. Contact mash-access@bath.ac.uk for help."
echo "-----------------------------------------------------------------"
...
echo "please do contact mash-access@bath.ac.uk for advice."
echo "-----------------------------------------------------------------"
...
echo "mash-access@bath.ac.uk for help."
